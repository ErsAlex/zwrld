...
from supply.views import  supply_manger_view, supply_create_detail_view, supply_delete, supply_acceptance_view, supply_detail_view, supply_approve_view,supply_save_view
